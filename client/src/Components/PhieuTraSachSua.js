...
function PhieuTraSachSua({handleClick}) {
  ...
  return (
    <div className="LPTS__wrapper-update" onClick={handleExit}>
      <div className="LPTS" onClick={e => e.stopPropagation()}>
        <h2 className="LPTS__h2">SỬA PHIẾU TRẢ SÁCH</h2>
        <div  className="LPTS__section"> 
            ...
            <div className="section-tables">
                ...
                <div className="section-tables__click button--hover">
                    <button className="Click-success">Tạo phếu</button>
                </div>
            </div>
        </div> 
      </div>
...
export default PhieuTraSachSua
