...
function PhieuThuTienPhatSua({handleClick}) {
  ...
  const handleExit = () => {
    const exit = document.querySelector('.phieuthu-update')
    exit.style.display = 'none'
  }

  return (
    <div className="phieuthu-update" onClick={handleExit}>
...
export default PhieuThuTienPhatSua
